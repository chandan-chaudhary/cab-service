...
const LandingPage:React.FC = () => {
    ...
    return(
        ...
        <div className={'flex flex-col lg:flex-row  items-center   pb-16 bg-gray-100 px-3 mx-auto lg:pl-24'}>
            <div className={' flex flex-col items-center justify-center space-y-8 pt-8 pb-16 bg-gray-100 px-3 xl:pl-12 xl:pt-24 '}>
                {/*TOP DIV*/}
                <div className={'px-3 text-blue-950 pb-4'}>
                    ...
                    <div className={'flex justify-around pt-7 text-md lg:text-lg text-center items-center font-semibold'}>
                ...
                {/*BOOKING STATUS*/}
                <div className={'grid grid-cols-4 gap-1 xl:gap-x-3 items-center justify-center '}>
                    {bookingOption.map((booking, i) =>
                            <div key={i} onClick={() => handleSelectedRoute(booking.bookingType)} className={`flex flex-col px-2 py-2 mx-1   text-center items-center rounded-xl uppercase text-blue-950 space-y-2 ${booking.bookingType === isSelected && 'bg-yellow-400'}  `}>
                                <booking.bookIcon className={`text-2xl lg:text-3xl `}/>
                                <span className={'text-[12px]  font-bold '}>{booking.bookingType}</span>
                            </div>
                    )}
                </div>
            ...
            {/*<div className={'xl:pl-12  flex '}>*/}
                <img src={touristImg} alt={'tourist img'} className={'opacity-70 lg:absolute lg:-right-10 lg:top-[600px]  lg:w-6/12 '}/>
            {/*</div>*/}
        </div>
        </section>
    )
